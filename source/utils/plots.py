...
def plot_trend(data:torch.Tensor, edu, mask_retirement, type, func,plots_base_dir= None, epoch = None, save = False):
    ...
    if func == 'mean':
        ...
        plt.plot( data[edu > 0].nanmedian(dim=0).values, axis = 1, color='skyblue', label='edu = 1')
