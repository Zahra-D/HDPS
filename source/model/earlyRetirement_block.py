...
class EarlyRetiermentBlock(nn.Module):
      ...
      def forward(self, theta, edu, a_w_t, a_r_t, all_y, w_t, pr_bar_t, b_bar_t, discrete_setting= None):
        
        h_t, x_ww, pr_t, x_rw = self.working_block(theta, edu, a_w_t, all_y, discrete_setting= discrete_setting) 
